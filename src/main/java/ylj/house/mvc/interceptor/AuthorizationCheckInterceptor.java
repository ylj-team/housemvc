package ylj.house.mvc.interceptor;
...
public class AuthorizationCheckInterceptor extends HandlerInterceptorAdapter {
	...
	static Logger logger = LoggerFactory.getLogger(AuthorizationCheckInterceptor.class);

	//  private static final String[] IGNORE_URI = {"/login.jsp", "/Login/","backui/","frontui/"};
	 
	private List<String> excludedUrls;

	public AuthorizationCheckInterceptor(){
		logger.info("LoggedInterceptor created.");
	}
